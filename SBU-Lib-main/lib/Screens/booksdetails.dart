...
class _BookDetailsState extends State<BookDetails> {
  ...
  void _requestBorrow() async {
    ...
    try {
      ...
      final userCollege =
          userDoc.data()?['selected_college'] ?? 'Unknown College';
      final userPhone = userDoc.data()?['phone'] ?? 'Unknown Phone Number';

      // Format the date
      final requestDate = DateFormat('yyyy-MM-dd').format(DateTime.now());
      ...
      final bookImage =
          bookDoc.data()?['imageUrl'] ?? 'https://via.placeholder.com/150';
      ...
      await FirebaseFirestore.instance
        ...
        'bookTitle': bookTitle,
        'bookImage': bookImage,
        'date': requestDate, // Store the formatted date
        'status': 'Pending',
      });
